...
const Blood_Bank = () => {
  ...
  return (
    <div className='w-full flex justify-center items-center flex-wrap'>
      <div className='lg:w-10/12 h-auto w-full flex flex-wrap flex-col justify-center items-center p-20 '>
    <h1 className='text-2xl text-red-500 font-semibold py-2 w-full text-left'>Blood Bank Details</h1>
    ...
    <div className='w-full h-auto flex flex-wrap justify-center items-center border-2 border-b-gray-500 p-10'>
