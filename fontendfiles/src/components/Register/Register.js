...
const Register = () => {
    return (
      ...
      <div className='flex py-10 px-10 text-yellow-400 font-bold'>
        ...
        <div >
    <div  className='mt-40 ml-12 shadow-lg  shadow-gray-500 mr-52 p-10 w-2/3'>
    <h1 className='text-3xl font-semibold'>Pre-Register</h1>
     <div>
        ...
        <input className='w-full py-3 px-2 border-y-2  mb-5' type="password" placeholder='confirm password here' /> <br />
        <Link to="/login"><p className=' text-red-600'>Already have Account</p></Link>
        <button className='text-xl bg-red-600 py-2 px-5 font-bold mt-6 text-white hover:bg-red-400 ease-in duration-300'>Get Otp</button>
