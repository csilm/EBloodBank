  ...
  return (
    ...
    <div className='h-auto lg:w-1/3 w-full  flex flex-wrap justify-center items-center flex-col'>
      <div className='h-auto w-full flex flex-wrap p-2 justify-center items-center'>
          ...
          <p className='text-xs font-thin'>The tiny 'plates' in blood that wedge together to help to clot and reduce bleeding. Always in high demand, Vital for people with low platelet count, like malaria and cancer patients.</p>
      </div>
      <div className='h-auto w-full flex flex-wrap p-2 justify-center items-center'>
          <h1 className='text-lg font-bold w-full justify-center items-center'>Who can donate?</h1>
          <p className='text-xs font-thin'>You need to be 18-70 years old (men), weigh 50kg or more and have given a successful plasma donation in the past 12 months</p>
      </div>
    </div>
    <div className='h-auto lg:w-1/3 w-full border-black border-x-2 flex flex-wrap justify-center items-center flex-col'>
      <div className='h-auto w-full flex flex-wrap p-2 justify-center items-center'>
          ...
          <p className='text-xs font-thin'>Cancer, blood diseases, haemophilia, anaemia, heart disease, stomach disease, kidney disease, childbirth, operations, blood loss, trauma, burns.
          </p>
      </div>
      <div className='h-auto w-full flex flex-wrap p-2 justify-center items-center'>
          <h1 className='text-lg font-bold w-full justify-center items-center'>Lasts For?</h1>
          <p className='text-xs font-thin'>Just five days..</p>
      </div>
    </div>
    <div className='h-auto lg:w-1/3 w-full flex flex-wrap justify-center items-center flex-col'>
    <div className='h-auto w-full flex flex-wrap p-2 justify-center items-center'>
          <h1 className='text-lg font-bold w-full justify-center items-center'>How does it work?</h1>
          <p className='text-xs font-thin'>We collect your blood, keep platelet and return rest to you by apheresis donation.</p>
      </div>
      <div className='h-auto w-full flex flex-wrap p-2 justify-center items-center'>
          <h1 className='text-lg font-bold w-full justify-center items-center'>How long does it take?</h1>
          <p className='text-xs font-thin'>45 minutes to donate.</p>
      </div>
      <div className='h-auto w-full flex flex-wrap p-2 justify-center items-center'>
          <h1 className='text-lg font-bold w-full justify-center items-center'>How often can I donate?</h1>
          <p className='text-xs font-thin'>Every 2 weeks</p>
      </div>
    </div>
  </div>
  )
